...
class BaseAmplitude(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Amplitude']] = 'Amplitude'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.AmplitudeActions[_PrismaModelT]':
        from .client import get_client

        return actions.AmplitudeActions[_PrismaModelT](client or get_client(), cls)
