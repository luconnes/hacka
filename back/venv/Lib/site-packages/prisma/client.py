...
SCHEMA_PATH = Path('C:/Users/Vinicius/Creck hackaton/hacka/back/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\Vinicius\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    amplitude: 'actions.AmplitudeActions[models.Amplitude]'
    ...
    def __init__(
        ...
        *,
        ...
        self.amplitude = actions.AmplitudeActions[models.Amplitude](self, models.Amplitude)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/Vinicius/Creck hackaton/hacka/back/prisma/schema.prisma',
        }
...
class Batch:
    ...
    amplitude: 'AmplitudeBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.amplitude = AmplitudeBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class AmplitudeBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.AmplitudeCreateInput,
        include: Optional[types.AmplitudeInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
            model=models.Amplitude,
            arguments={
                'data': data,
                'include': include,
            },
    ...
    def create_many(
        self,
        data: List[types.AmplitudeCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> None:
        if skip_duplicates and self._batcher._active_provider in CREATE_MANY_SKIP_DUPLICATES_UNSUPPORTED:
    ...
    def delete(
        self,
        where: types.AmplitudeWhereUniqueInput,
        include: Optional[types.AmplitudeInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update(
        self,
        data: types.AmplitudeUpdateInput,
        where: types.AmplitudeWhereUniqueInput,
        include: Optional[types.AmplitudeInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.AmplitudeWhereUniqueInput,
        data: types.AmplitudeUpsertInput,
        include: Optional[types.AmplitudeInclude] = None,
    ) -> None:
        self._batcher._add(
            method='upsert',
    ...
    def update_many(
        self,
        data: types.AmplitudeUpdateManyMutationInput,
        where: types.AmplitudeWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.Amplitude,
    ...
    def delete_many(
        self,
        where: Optional[types.AmplitudeWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.Amplitude,
